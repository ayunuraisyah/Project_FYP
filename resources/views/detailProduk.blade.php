...
<div class="flex items-center justify-center">
  <div class="w-full max-w-[700px] h-auto md:h-[500px] p-4">
    <div class="flex flex-col md:flex-row w-full h-auto md:h-[80%] justify-center md:space-x-8 pt-[75px] ">
        ...
        <div class="flex mt-4 space-x-8">
          <form action="{{ route('user.buyNow') }}" method="post">
            ...
            <div>
              ...
              <input type="number" name="qty" id="" placeholder="Please insert quantity" required class="w-full md:w-auto">
              {{-- <button class="px-2 py-2 text-white bg-gray-400">></button> --}}
            </div>

            <div class="bg-green-600 rounded-[20px] w-full md:w-[130px] h-[35px] flex justify-center items-center mt-4">
