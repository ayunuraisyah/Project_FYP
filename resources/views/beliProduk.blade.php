...
<div class="w-[1000px] h-[100vh] mx-auto">
    <div class="pt-[60px]">
        ...
        <div class="w-[95%] h-[2px] bg-black mx-auto"></div>
    </div>
                    ...
                    <table class="ml-6">
                        ...
                        @if(session()->has('buyNow'))
                            @foreach ($dataItems as $data)
                                ...
                                <tr>
                                    <td class="flex mt-4"><img src="/storage/{{ $data->thumbnail }}" alt="" class="w-[130px] h-[100px]"><p class="ml-6 mt-6">{{ $data->title }},<br>{{ $data->origin }}</p></td>
                                    <td class="pl-2">Rp {{ number_format($data->price) }}</td>
                                    <td class="pl-2">{{ $totalqtyBuyNow }}</td>
                                    <td class="pl-2">Rp {{ number_format($totalqtyBuyNow * $data->price) }}</td>
                                </tr>   
                            @endforeach
                        @else
...
=======
                ...
                <div class="flex">
                    <div class="w-[200px] h-[50px] ml-[40px] mt-4">
                        <p>{{ auth()->user()->name }}</p>
                    </div>
                    <div class="w-[600px] h-[50px] ml-[8px] mt-4">
...
>>>>>>> 4540b2eb29d9edd2db3124c7c396cfd8784dc226
            ...
            <div class="w-[900px] h-[550px] bg-[#D9D9D9] mx-auto mt-6">
                ...
                <div class="w-[95%] h-[2px] bg-black mx-auto"></div>
                @error('bank')
                    <div class="invalid-feedback text-center text-red-600">{{ "Please selet one of the bank" }}</div>
                @enderror
